...
public class HideRgbEvaluator implements TypeEvaluator {
    ...
    private static final org.androidtown.conn.boommenu.Animation.HideRgbEvaluator sInstance = new org.androidtown.conn.boommenu.Animation.HideRgbEvaluator();

    public static org.androidtown.conn.boommenu.Animation.HideRgbEvaluator getInstance() {
        return sInstance;
    }
