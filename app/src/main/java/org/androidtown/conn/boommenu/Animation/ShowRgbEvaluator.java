package org.androidtown.conn.boommenu.Animation;
...
public class ShowRgbEvaluator implements TypeEvaluator {
    ...
    private static final org.androidtown.conn.boommenu.Animation.ShowRgbEvaluator sInstance = new org.androidtown.conn.boommenu.Animation.ShowRgbEvaluator();

    public static org.androidtown.conn.boommenu.Animation.ShowRgbEvaluator getInstance() {
        return sInstance;
    }
